...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  asmrSearch: (keyword: string, page: number) => ipcRenderer.invoke('asmr-search', keyword, page),
  asmrGetWorks: (page: number, order?: string, sort?: string) => ipcRenderer.invoke('asmr-get-works', page, order, sort),
